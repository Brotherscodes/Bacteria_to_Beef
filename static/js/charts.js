...
function buildCharts(sample) {
  ...
  d3.json("samples.json").then((data) => {
    ...
    // D3-1. Create a variable that filters the samples for the object with the desired sample number.
    ...
    var barLayout = {
      title: `Top Ten Bacteria Found in Sample ${sample}`,
    };
  ...
  //samples.json not available below here
}